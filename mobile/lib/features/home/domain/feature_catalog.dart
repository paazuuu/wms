      ...
      FeatureGroup(
        ...
        entries: [
          FeatureEntry(
            id: 'inspection',
            label: 'Inspection',
            description: 'Barcode & quantity checks, NG records',
          ...
          FeatureEntry(
            id: 'receiving',
            label: 'Receiving',
            description: 'Receive POs, auto-start inspection',
          ...
          FeatureEntry(
            ...
            description: 'Scan to add or remove with a reason',
          ...
          FeatureEntry(
            id: 'stock_count',
            label: 'Stock Count',
            description: 'Cycle count by location',
          ...
          FeatureEntry(
            id: 'picking',
            label: 'Picking',
            description: 'Fulfil sales orders by scan',
      ...
      FeatureGroup(
        ...
        entries: [
          FeatureEntry(
            ...
            description: 'Scan a barcode to view product & stock',
          ...
          FeatureEntry(
            id: 'locations',
            label: 'Locations',
            description: 'Bins, zones and transfers',
          ...
          FeatureEntry(
            id: 'lots_serials',
            label: 'Lots & Serials',
            description: 'Batch and serial tracking',
      ...
      FeatureGroup(
        ...
        entries: [
          ...
          FeatureEntry(
            id: 'reports',
            label: 'Reports',
            description: 'Saved reports & exports',
